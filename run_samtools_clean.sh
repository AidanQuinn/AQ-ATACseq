...
for s in `cat ./samples.txt`; do
    ...
    # sort by name
    echo "Sorting ${s}..."
    samtools sort -n -@ 23 -m 10G -o ./aligned/${s}_mm10_nsorted.bam ./aligned/${s}_mm10.bam
    ...
    samtools sort -@ 23 -m 10G -o ./aligned/${s}_mm10_nsorted_fixed_dedup_psorted.bam ./aligned/${s}_mm10_nsorted_fixed_dedup.bam
